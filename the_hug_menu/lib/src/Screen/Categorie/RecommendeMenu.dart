...
class _RecommendeMenuState extends State<RecommendeMenu> {
  final List<ProductModel> _listProduct = [
    ProductModel(
      ...
      image: "assets/images/recommande/pingnom.jpeg",
    ),
    ProductModel(
      productId: "2",
      productName: "ປີ້ງຄູຄັນນາ",
      price: "69.000 ກີບ",
      productType: recommendeMenuType,
      image: "assets/images/recommande/pingkhoukanna.jpeg",
    ),
    ProductModel(
      productId: "3",
      productName: "ປີ້ງເສືອຮ້ອງໃຫ້",
      price: "69.000 ກີບ",
      productType: recommendeMenuType,
      image: "assets/images/recommande/pingseuihonghai.jpeg",
    ),
    ProductModel(
      productId: "4",
      productName: "ປີ້ງຊີ້ນນ້ຳຕົກ",
      price: "69.000 ກີບ",
      productType: recommendeMenuType,
      image: "assets/images/recommande/pingNamtok.jpeg",
    ),
    ProductModel(
      productId: "5",
